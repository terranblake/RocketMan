...
public class MatchLauncher : MonoBehaviour
{
    ...
    [Tooltip("The Scene name to load following the lobby.")]
    ...
    {
		LogFeedback("<Color=Yellow>OnJoinedRoom</Color> Room <" + PhotonNetwork.room.Name + ">");
        ...
        {
            Debug.Log(string.Format("We load the scene for the match."));
		...
		//PhotonNetwork.Instantiate("NetworkActions", Vector3.zero, Quaternion.identity, 0);
    }
